...
export default function Home() {
  return (
    <div>
      <Head>
        <title>The Tailor Shop.com - Wear the Code </title>
        <meta name="description" content="The Tailor Shop - Wear the Code" />
        <link rel="icon" href="/favicon.ico" />
      </Head>   
     <div>
     <Image src="/home.jpg" alt="" width={2000} height={1} />
     </div>
     <section className="text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Wear The Code with The Tailor Shop.com</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear whatever you want to. What do your want ? Do You want code ? so, why not wear the code??</p>
    </div>
