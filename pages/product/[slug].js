...
const Post = ({addtoCart}) => {
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto px-24 object-cover object-center rounded" src="https://i.pinimg.com/564x/39/5b/97/395b975823fda1d5d7bed41c12fe6821.jpg"/>
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 class="text-sm title-font text-gray-500 tracking-widest">The Tailor Shop</h2>
        ...
        <div class="flex">
          ...
          <button onClick = {() => addtoCart(slug, 1, 58, 'Wear the code(XL, Red)', "Xl","Red")} class="flex ml-2 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded">Buy Now</button>
